...
class TestFamilyTree(TestCase):
    ...
    @patch('family_tree.family_tree.Member', return_value=create_fake_member(id=1, name="Zim", gender=Gender.male))
    def test_add_child(self, mock_member):
        ...
        # if either mother or father do not exist
    ...
    @patch('family_tree.family_tree.Member', return_value=create_fake_member(id=1, name="Wife", gender=Gender.female))
    def test_add_spouse(self, mock_member):
        ...
        spouse_c = create_fake_member(id=3, name="MarriedMember", gender=Gender.male, spouse=spouse_b)
        ...
        self.assertEqual(self.ftree.add_spouse("Wife", Gender.female, "Zim"), "SPOUSE_ADDITION_SUCCEDED")
