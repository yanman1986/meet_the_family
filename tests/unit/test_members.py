...
class TestMember(TestCase):
    ...
    def test_get_paternal_aunt(self, mock_get_paternal_grandmother):
        ...
        # to check that the mock_get_paternal_grandmother was called instead of self.member.get_paternal grandmother
    ...
    def test_get_relationship(self, mock_get_paternal_aunt, mock_get_paternal_uncle,
        ...
        self.assertEqual(self.member.get_relationship('invalid_value'), [])
