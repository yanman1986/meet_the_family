...
class Member:
    ...
    def get_paternal_aunt(self):
        ...
        if not grandmother.children:
            return []
        return list(
            filter(lambda x: x.gender == Gender.female, grandmother.children))
    ...
    def get_paternal_uncle(self):
        ...
        if not grandmother.children:
            return []
        return list(
            filter(lambda x: x.gender == Gender.male and x.name != self.father.name, grandmother.children))
    ...
    def get_maternal_aunt(self):
        ...
        if not grandmother.children:
            return []
        return list(
            filter(lambda x: x.gender == Gender.female and x.name != self.mother.name, grandmother.children))
    ...
    def get_maternal_uncle(self):
        ...
        if not grandmother.children:
            return []
        return list(
            filter(lambda x: x.gender == Gender.male, grandmother.children))
    ...
    def get_brother_in_law(self):
        ...
        if not spouse_mother.children:
            return []
        return list(
            filter(lambda x: x.gender == Gender.male and x.name != self.spouse.name, spouse_mother.children))
    ...
    def get_sister_in_law(self):
        ...
        if not spouse_mother.children:
            return []
        return list(
            filter(lambda x: x.gender == Gender.female and x.name != self.spouse.name, spouse_mother.children))

    def get_son(self):
        if not self.children:
            return []
        return list(
            filter(lambda x: x.gender == Gender.male, self.children))

    def get_daughter(self):
        if not self.children:
            return []
        return list(
            filter(lambda x: x.gender == Gender.female, self.children))
    ...
    def get_siblings(self):
        ...
        if not self.mother.children:
            return []
        return list(
            filter(lambda x: x.name != self.name, self.mother.children))
